...
\ref{sec:foundations} y $u \in \R$ es un escalar. Podemos suponer, sin pérdida de generalidad, que
todas las entradas de $\vec{p}$ son distintas de cero. En efecto, si alguna entrada $p_i$ es nula,
cualquier elección entera y no negativa de $x_i$ es válida para este programa lineal entero. Esta
suposición será implícita en lo que resta del capítulo, aunque se hará explícita en algunas
ocasiones para profundizar el caso cuando alguna entrada sea nula. Cuando introduzcamos en el capítulo
4 múltiples restricciones nos desharemos de este supuesto.
...
\eqref{theory:formulation} es esencialmente el mismo. En conclusión, encontramos una suerte de
