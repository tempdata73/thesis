...
generalidad. No obstante, los resultados se mantienen para cualquier $n \in \N_{\geq 2}$.
...
\begin{observation}
	...
	$A$. En la Figura \ref{fig:hyp} se muestra visualmente esta relación entre semi-espacios afinos y
	poliedros.
\end{observation}
