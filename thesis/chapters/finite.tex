...
El teorema \ref{th:intnonneg1} provee, hasta donde llega el conocimiento del autor, nuevas cotas
superiores para el número de Frobenius en el Problema Diofantino de Frobenius \cite{frob}. De manera
resumida, dada una colección de enteros $q_1, \ldots, q_n$ coprimos, el número de Frobenius es el
entero $F$ más grande tal que $F$ no pueda ser expresado como una combinación lineal entera no
negativa de $q_1, \ldots, q_n$. En efecto, o bien $F$ es mayor o igual que el lado derecho de
...
estudio sobre cómo se compara esta colección de cotas con respecto a las presentadas en el capítulo
3 de \cite{frob}, por ejemplo, queda fuera del propósito de esta tesis.
...
Utilizamos el mismo equipo así como la misma configuración de CBC que se detalla en la subsección
\ref{subsec:inf:res} para la realización de estos experimentos.
...
y $\sigma$ son la media y desviación estándar de los tiempos medidos, respectivamente. Las casillas
vacías indican que el método no encontró una solución para el problema correspondiente en menos de
los 300 segundos de tolerancia.
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\linewidth]{/home/tempdata/repos/thesis/static/fin/rhs/boxplot-cv.pdf}
