...
debido al límite suave en las llamadas de recursión que permite Python. Este límite es de 3000
llamadas recursivas en la máquina donde se realizaron los experimentos. Esto significa que, de
manera predeterminada, solamente podríamos resolver problemas de dimensión $n \leq 3000$. No
...
lado derecho de \eqref{theory:constraint:budget} es $\hat{u}$ y se escogieron todas menos las
...
autor de esta FD incluye una manera de construir la solución, a pesar del costo adicional en eficiencia.
...
\ref{table:fin:mt:cv} muestra los coeficientes de variación de estos tiempos. Un coeficientes de
...
\begin{table}[ht]
	...
	\begin{tabularx}{\linewidth}{@{}r *{4}{S[table-format=3.3]@{\,}l}@{}}
		...
		& \multicolumn{2}{c}{\texttt{dioph\_right}} \\
		\midrule
		1000     & 1.270   & (±0.1)   & 0.109   & (±0.02) & 0.013   & (±0.00) & 0.013   & (±0.00) \\
		2000     & 10.368  & (±0.02)  & 0.135   & (±0.02) & 0.042   & (±0.00) & 0.043   & (±0.00) \\
		5000     & 160.562 & (±0.39)  & 1.666   & (±0.20) & 0.245   & (±0.00) & 0.265   & (±0.00) \\ \midrule
		10000    &         &          & 2.124   & (±0.33) & 1.063   & (±0.00) & 1.164   & (±0.00) \\
		20000    &         &          & 7.682   & (±0.34) & 4.595   & (±0.01) & 4.991   & (±0.01) \\
		30000    &         &          & 19.192  & (±1.18) & 10.743  & (±0.02) & 11.553  & (±0.01) \\
		40000    &         &          & 24.334  & (±0.19) & 19.471  & (±0.02) & 20.994  & (±0.08) \\
		50000    &         &          & 38.940  & (±0.18) & 30.887  & (±0.03) & 33.451  & (±0.04) \\
		60000    &         &          & 51.962  & (±0.53) & 45.072  & (±0.05) & 48.545  & (±0.05) \\
		70000    &         &          & 81.033  & (±1.26) & 61.885  & (±0.04) & 66.345  & (±0.10) \\
		80000    &         &          & 116.618 & (±0.93) & 81.418  & (±0.06) & 87.726  & (±0.12) \\
		90000    &         &          & 141.683 & (±2.10) & 103.962 & (±0.04) & 111.553 & (±0.12) \\ \midrule
		100000   &         &          & 170.397 & (±1.75) & 129.440 & (±0.05) & 139.652 & (±0.16) \\
		150000   &         &          &         &          & 299.154 & (±0.13) &         &          \\
		\bottomrule
	\end{tabularx}
	\end{subtable}
...
En ambos R\&A métodos diofantinos hay presencia de un comportamiento oscilatorio. El autor
está seguro que esto ocurre cuando el presupuesto $u$ es múltiplo de una de las entradas de $\vec{p}$
(para R\&A) o de $\vec{q}$ (para los métodos diofantinos). En estos casos el problema es trivial,
pues si $p_j \mid u$, entonces R\&A encuentra inmediatamente la solución óptima
\begin{equation*}
	x_i \coloneq \begin{cases}
		\floor{u / p_i} & i = j, \\
		0 & \text{e.o.c.},
	\end{cases}
\end{equation*}
y similarmente para los métodos diofantinos. Si bien esta situación fue previsible en el diseño del
experimento, deshacernos de estas observaciones ocultaría el comportamiento lineal de FD con respecto 
al presupuesto $u$. Esto, a su vez, debilitaría nuestro argumento sobre la complejidad de FD en la
subsección \ref{subsec:fin:dp}.

Destaca la inestabilidad del método de R\&A. Una hipótesis del autor es que esto es causado por la
constante transferencia de datos entre los módulos del problema relajado y la generación de cortes
(ver figura \ref{p1c11:fig:MIP_solver_flowchart}) dentro del \textit{solver} CBC. Por ello, el autor
decidió correr el mismo experimento tomando en cuenta una configuración de R\&A que prohíba la
generación de cortes. Debido a la dimensión $n = 1{,}000$ del problema y al fenómeno expuesto en la
sección \ref{sec:inf:exp}, no prohibimos el uso de heurísticas.
