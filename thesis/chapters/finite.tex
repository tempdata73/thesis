...
Buscamos expresar el radio $r_\sigma$ en función de $\eta$, por lo que debemos realizar un par de
...
\begin{align*}
	...
	% &=
	% \left( \frac{\eta}{\vec{q}_j}\vec{e}_j - \frac{\eta}{\norm{\vec{q}}^2}\vec{q} \right)^T
	% \left( \frac{\eta}{n\vec{q}_1}, \ldots, \frac{\eta}{n\vec{q}_i} - \frac{\eta}{\vec{q}_i}, \ldots,
	% 		\frac{\eta}{n\vec{q}_n} \right) \\
	% &=
	% \eta^2
