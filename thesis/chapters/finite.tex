...
\begin{theorem}
	...
	El algoritmo \ref{algo:fin:helper} de la página \pageref{algo:fin:helper} es correcto.
\end{theorem}
\begin{proof}
...
\begin{theorem}
	...
	El algoritmo \ref{algo:fin:dioph} de la página \pageref{algo:fin:dioph} es correcto.
\end{theorem}
\begin{proof}
