...
\begin{proof}
	...
	\end{equation*}
	($\subseteq$) Sea $\vec{x} \in \sigma$, de la definición \ref{def:simplex} y de \eqref{aff:contention} encontramos
	...
	($\supseteq$) El otro lado de la contención se muestra análogamente.
\end{proof}
...
$\vec{p}$ (ve página 82 de \cite{martello}). Observemos que si $u \geq
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.8\linewidth]{/home/tempdata/repos/thesis/static/fin/rhs/times-macro.pdf}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.7\linewidth]{/home/tempdata/repos/thesis/static/fin/rhs/boxplot-cv.pdf}
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.7\linewidth]{/home/tempdata/repos/thesis/static/fin/rhs/boxplot-cv-wbb.pdf}
