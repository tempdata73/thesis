...
la ecuación lineal diofantina $\vec{q}^T\vec{x} = k$. En los teoremas \ref{th:equiv} y
\ref{th:isoclass} se exploran las consecuencias de esto: en el primero y más general se sugiere que en
realidad hay una sola clase de equivalencia entre programas lineales enteros, pues todos los
vectores coprimos inducen descomposiciones isomorfas que respetan la estructura de las subredes; el
segundo sacrifica esta generalidad a cambio de una manera más computacionalmente eficiente de
calcular las matrices unimodulares que testifican estos isomorfismos de redes.
