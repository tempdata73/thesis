...
\ref{fig:exp:inf:hist} muestra la distribución de estos multiplicadores, donde recortamos los
multiplicadores a un máximo de 100. En realidad, el multiplicador más grande fue aproximadamente 5422.

De acuerdo a la subsección anterior, deberíamos esperar que la gran mayoría de los multiplicadores
se concentren alrededor de $10^{n} = 10000$. No obstante, el 20\% de las observaciones tiene un
...
solución fue a causa de una heurística y no por el método ``tradicional'' de ramificación. Por la
