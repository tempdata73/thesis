...
nuestro algoritmo \eqref{algo:inf:ext}, o incluso con la cota inferior \eqref{eq:bbound}.
...
Por cuestiones de tiempo, cada corrida fue automáticamente terminada si sobrepasaba los 300 segundos
Decimos que el método no encontró una solución si fue automáticamente terminado en más de 10 de las
20 veces que medimos el tiempo de terminación. Para verificar la correctud en la implementación de
nuestro algoritmo, comparamos los valores objetivo de nuestra implementación con los de CBC y en
ningún momento encontramos que fueran distintos. Nuestra implementación se encuentra libre en
...
\begin{figure}[hbtp]
  ...
  \caption{Tiempos de terminación promedio cuando varía el presupuesto y el
			número de digitos. \textit{Arriba}: Resultados en segundos de CBC. \textit{Abajo}:
...
conteo en los archivos de registro generados por CBC, descubrimos que en
\textbf{todos} los casos que se encontró una solución fue a causa de una heurística y no por el
