...
enteros. Este método se basa en el famoso paradigma de divide y vencerás, el cual combina las
...
restricciones activas del programa lineal entero. En este caso, el programa relajado cuenta con una infinidad
...
complejidad es polinomialmente acotada. Finalmente, realizamos una serie de experimentos numéricos
que permiten comparar los tiempos de terminación de nuestro algoritmo con los de Ramificación y
Acotamiento.
