...
\noindent
En gran medida, esta tesis analiza programas lineales enteros del tipo
\begin{subequations}
	\label{eq:base}
	\begin{align}
...
dedicamos a estudiar casi exclusivamente estas instancias: en primer lugar, el hecho de que este
problema tenga una sola restricción facilita su análisis y su interpretación geométrica; y, en segundo
...
algoritmos alternativos y posiblemente más eficientes que R\&A.
...
extenso para añadirlo a la tesis, la discusión en este capítulo es más superficial, pero no por ello
menos rigurosa.
