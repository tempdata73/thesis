...
2 y 3; y los teoremas \ref{th:equiv} y \ref{th:isoclass}, los cuales dan inicio a una clasificación
de programas lineales enteros.
...
Debido a la gran cantidad de resultados presentados en esta tesis, empleamos la siguiente estrategia
para diferenciar los que son, en pleno conocimiento del autor, originales, de aquellos que forman
parte de la literatura tradicional: si un resultado es de conocimiento público, entonces tendrá una
referencia asociada cuando lo enunciemos por primera vez; de lo contrario, el resultado es original,
o al menos fue obtenido de manera independiente por el autor. La única excepción a esta regla es en
la sección de prerrequisitos \ref{sec:prerreq}, donde preferimos mostrar las referencias en la
introducción, pues ningún resultado de esa sección es original ni independiente.
