...
\makenomenclature
\renewcommand{\nomname}{Nomenclatura}
\renewcommand{\pagedeclaration}[1]{\dotfill página~#1}
\usepackage{etoolbox}
\renewcommand\nomgroup[1]{%
  \item[\bfseries
  \ifstrequal{#1}{A}{Abreviaciones}{%
  \ifstrequal{#1}{B}{Símbolos reservados}{%
  \ifstrequal{#1}{C}{Convenciones}{}}}%
]}
...
\renewcommand{\ker}[1]{\operatorname{ker}\braces{#1}}
