...
\begin{frame}{Sobre Ramificación y Acotamiento}
	Utilizado para resolver programas lineales enteros o programas lineales mixtos. 
	\begin{itemize}
		\item Interés académico: ¿$P \subsetneq NP$?, ¿$P = NP$-completo?
		\item Interés comercial: Nvidia, IBM, Gurobi, FICO, Artelys, Cardinal Operations, Alibaba
			MindOpt, MOSEK,...
	\end{itemize}
\end{frame}
...
\begin{frame}{Sobre los cortes de Ramificación y Acotamiento}
	\begin{stheorem}
...
\begin{frame}{Sobre la separabilidad del Problema Equivalente}
